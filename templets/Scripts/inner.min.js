$(function() {
    ...
    if (window.location.host.indexOf("#.com") > 0) {
        $("section").add();
        return
    }
    dockEvent();
    ...
    $(".toolbar .switch").bind("touchstart click",
    function(e) {
...
function dockEvent() {
    $(".dock").height($(".dock ul.icons li").length * 1 - 5);
    $(".dock ul.icons li i").bind("touchstart mouseenter click",
    function() {
    ...
    $(".dock ul.icons li.up i").bind("touchstart click",
    function() {
        $("html,body").animate({
            scrollTop: 0
        },
